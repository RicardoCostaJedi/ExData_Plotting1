...
## Plot 1
  png(filename="./plot1.png")  # Open png device
  hist(SubsetDFrame$Global_active_power, main=paste("Global Active Power between",InitialDate,"and", EndDate),xlab='Global Active Power (kilowatts)', col='red') # Make plot
  dev.off()